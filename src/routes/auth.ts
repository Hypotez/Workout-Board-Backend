import { setCookies, clearCookies } from '../crypto/jwt.js'
import { CreateUserSchema, LoginUserSchema } from '../schemas/shared/auth.js'
import { cookieAuth } from '../middleware/middleware.js'
